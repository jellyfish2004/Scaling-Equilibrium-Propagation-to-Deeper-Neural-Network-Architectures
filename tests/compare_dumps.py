...
Run from repo root:
    python tests/compare_dumps.py --verbose
    python tests/compare_dumps.py --orig_dir dumps/original --new_dir dumps/new --verbose
...
def main():
    ...
    comparison_types = ['free_states', 'pos_nudged_states', 'neg_nudged_states', 
