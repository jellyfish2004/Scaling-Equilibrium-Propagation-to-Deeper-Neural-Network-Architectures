...
eqprop_new_dir = os.path.abspath(os.path.join(current_dir, ".."))
sys.path.insert(0, eqprop_new_dir)

# Path to original EquiProp for weight sync
...
def main():
    ...
    parser.add_argument('--inputs_file', type=str, default='../../EquiProp/dumps/shared_inputs.pt',
